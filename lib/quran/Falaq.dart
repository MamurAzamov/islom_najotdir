    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          const Text("1. (Ey, Muhammad,) ayting: Panoh tilab iltijo qilurman tong Parvardigoriga,",style: TextStyle(fontSize: 16),),
          const SizedBox(height: 5,),
          const Text("2. yaratgan narsalari yovuzligidan,",style: TextStyle(fontSize: 16),),
          const SizedBox(height: 5,),
          const Text("3. zulmatga cho'mgan tun yovuzligidan,",style: TextStyle(fontSize: 16),),
          const SizedBox(height: 5,),
          const Text("4. tugunchalarga dam uruvchi ayollar yovuzligidan",style: TextStyle(fontSize: 16),),
          const SizedBox(height: 5,),
          const Text("5. hamda hasadchining hasadi yovuzligidan.",style: TextStyle(fontSize: 16),),
          ElevatedButton(
            onPressed: (){
