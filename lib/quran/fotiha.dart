    ...
    return Scaffold(
      ...
      child: ListView(
        ...
        children: [
          ...
          const Text(
            "1. Mehribon va rahmli Alloh nomi ila (boshlayman).",
          ...
          const Text(
            "2. Hamd olamlar Robbi Allohgakim",
            style: TextStyle(fontSize: 16),
          ),
          const SizedBox(
            height: 5,
          ...
          const Text(
            "4. Jazo-mukofot kuning egasidir.",
            style: TextStyle(fontSize: 16),
          ),
          const SizedBox(
            height: 5,
          ...
          const Text(
            "5. Sengagina ibodat qilamiz va sendangina so'raymiz!",
            style: TextStyle(fontSize: 16),
          ),
          const SizedBox(
            height: 5,
          ...
          const Text(
            "7. (u) Sen in'om (hidoyat) etganlarning yo'liga, g'azabga uchragan va adashganlarning emas. ",
            style: TextStyle(fontSize: 16),
          ),
          const SizedBox(
            height: 10,
